...
def get_f_H_i(f_ang_H, f_sh_H):
    ...
    :param f_ang_H: 暖房期の垂直入射に対する斜入射の規準化日射熱取得率
    :type f_ang_H: float
    :param f_sh_H: 暖房期の日除け効果係数
    :type f_sh_H: float
...
def get_f_C_i(f_ang_C, f_sh_C):
    ...
    :param f_ang_C: 冷房期の垂直入射に対する斜入射の規準化日射熱取得率
    :type f_ang_C: float
    :param f_sh_C: 冷房期の日除け効果係数
    :type f_sh_C: float
...
def get_table_b_1(region, glass_spec_category, H_or_C, direction):
    ...
    :param H_or_CS: 計算対象
    :type H_or_CS: str
    :param direction: 開口部の面する方位
    :type direction: str
    :return: 垂直入射に対する斜入射の規準化日射熱取得率
    :rtype: float
    """
