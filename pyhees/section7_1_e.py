...
def calc_E_E_hs_d_t(L_dashdash_k_d_t, L_dashdash_s_d_t, L_dashdash_w_d_t, L_dashdash_b1_d_t, L_dashdash_b2_d_t,
    ...
    :type e_rtd: float
    :param theta_ex_d_Ave_d: 日付dにおける日平均外気温 (℃)
    :type theta_ex_d_Ave_d: ndarray
    :param theta_ex_Nave_d: 日付dにおける夜間平均外気温 (℃)
    :type theta_ex_Nave_d: ndarray
    :param CO2HP: CO2HPパラメーターの辞書
    :type CO2HP: dict
...
def get_E_E_hs_cm_d_t(E_E_HP_cm_d_t, E_E_aux_cm_d_t):
    ...
    :param E_E_HP_cm_d_t:日付dの時刻tにおける制御モードcmの1時間当たりのヒートポンプの消費電力量
    :type E_E_HP_cm_d_t: ndarray
    :param E_E_aux_cm_d_t:日付dの時刻tにおける制御モードcmの1時間当たりの補機の消費電力量
    :type E_E_aux_cm_d_t: ndarray
    :return: 日付dの時刻tにおける制御モードcmの1時間当たりの給湯機の消費電力量
    :rtype: ndarray
    """
...
def get_E_E_HP_cm_d_t(t_HP_stop, tau_dot_HP_cm_d, E_dot_E_HP_cm_d, tau_HP_cm_d_t):
    ...
    :param t_HP_stop:沸き上げ終了時刻
    :type t_HP_stop: float
    :param tau_dot_HP_cm_d:日付dにおける制御モードcmの1日当たりのヒートポンプ運転時間
    :type tau_dot_HP_cm_d: ndarray
    :param E_dot_E_HP_cm_d:日付dにおける制御モードcmの1日当たりのヒートポンプの消費電力量
    :type E_dot_E_HP_cm_d: ndarray
    :param tau_HP_cm_d_t:日付dの時刻tにおける制御モードcmの1時間当たりのヒートポンプ運転時間
    :type tau_HP_cm_d_t: ndarray
    :return: 日付dの時刻tにおける制御モードcmの1時間当たりのヒートポンプの消費電力量
    :rtype: ndarray
    """
...
def get_E_dot_E_HP_cm_d(E_dot_E_HP_bw_cm_d, E_dot_E_HP_def_cm_d):
    ...
    :param E_dot_E_HP_bw_cm_d:日付dにおける制御モードcmの1日当たりの沸き上げに係るヒートポンプの消費電力量
    :type E_dot_E_HP_bw_cm_d: ndarray
    :param E_dot_E_HP_def_cm_d:日付dにおける制御モードcmの1日当たりの除霜に係るヒートポンプの消費電力量
    :type E_dot_E_HP_def_cm_d: ndarray
    :return: 日付dにおける制御モードcmの1日当たりのヒートポンプの消費電力量
    :rtype: ndarray
    """
...
def get_E_dot_E_HP_bw_cm_d(Q_dot_HP_cm_d, e_hat_HP_cm_d):
    ...
    :param Q_dot_HP_cm_d:日付dにおける制御モードcmの1日当たりの沸き上げ熱量
    :type Q_dot_HP_cm_d: ndarray
    :param e_hat_HP_cm_d:日付dにおける制御モードcmのヒートポンプのM1スタンダードモードエネルギー消費効率
    :type e_hat_HP_cm_d: ndarray
    :return: 日付dの時刻tにおける制御モードcmの1日当たりの沸き上げに係るヒートポンプの消費電力量
    :rtype: ndarray
    """
...
def get_E_dot_E_HP_def_cm_d(E_dot_HP_bw_cm_d, C_def_cm_d):
    ...
    :param E_dot_HP_bw_cm_d:日付dにおける制御モードcmの1日当たりの沸き上げに係るヒートポンプの消費電力量
    :type E_dot_HP_bw_cm_d: ndarray
    :param C_def_cm_d:日付dにおける制御モードcmの除霜効率係数
    :type e_hat_HP_cm_d: ndarray
    :return: 日付dの時刻tにおける制御モードcmの1日当たりの除霜に係るヒートポンプの消費電力量
    :rtype: ndarray
    """
...
def get_e_hat_HP_cm_d(theta_ex_Nave_d, theta_star_ex_sum, theta_star_ex_imd, theta_star_ex_win, theta_star_ex_win_cd,
    ...
    :param theta_ex_Nave_d:日付dにおける夜間平均外気温度
    :type theta_ex_Nave_d: float
    :param theta_star_ex_imd:夏期条件の外気温度
    :type theta_star_ex_imd: float
    :param theta_star_ex_imd:中間期条件の外気温度
    :type theta_star_ex_imd: float
    :param theta_star_ex_win:冬期条件の外気温度
    :type theta_star_ex_win: float
    :param theta_star_ex_win_cd:標準条件の沸き上げ温度
    :type theta_star_ex_win_cd: float
    :param theta_star_ex_frst_upper:着霜領域（上限）の外気温度
    :type theta_star_ex_frst_upper: float
    :param theta_star_ex_frst:着霜期条件の外気温度
    :type theta_star_ex_frst: float
    :param e_hat_HP_sum_cm:制御モードcmの夏期条件におけるヒートポンプのM1スタンダードモードエネルギー消費効率
    :type e_hat_HP_sum_cm: float
    :param e_hat_HP_imd_cm:制御モードcmの中間期条件におけるヒートポンプのM1スタンダードモードエネルギー消費効率
    :type e_hat_HP_imd_cm: float
    :param e_hat_HP_win_cm:制御モードcmの冬期条件におけるヒートポンプのM1スタンダードモードエネルギー消費効率
    :type e_hat_HP_win_cm: float
    :param e_hat_HP_win_cd_cm:制御モードcmの寒冷地冬期条件におけるヒートポンプの除霜運転を除くM1スタンダードモードエネルギー消費効率
    :type e_hat_HP_win_cd_cm: float
    :param e_hat_HP_frst_upper_cm:制御モードcmの着霜領域（上限）におけるヒートポンプのM1スタンダードモードエネルギー消費効率
    :type e_hat_HP_frst_upper_cm: float
    :param e_hat_HP_frst_cm:制御モードcmの着霜期条件におけるヒートポンプの除霜運転を除くM1スタンダードモードエネルギー消費効率
    :type e_hat_HP_frst_cm: float
    :return: 日付dにおける制御モードcmのヒートポンプのM1スタンダードモードエネルギー消費効率
    :rtype: ndarray
    """
...
def get_e_hat_HP_cm(r_e_HP_cm, e_HP_sum_std, e_HP_imd_std, e_HP_win_std, e_HP_frst_upper_cm, e_HP_frst_high, e_HP_win_cd_high,
    ...
    :param r_e_HP_cm:制御モードcmの実動効率比
    :type r_e_HP_cm: float
    :param e_HP_sum_std:夏期-標準条件におけるヒートポンプのエネルギー消費効率
    :type e_HP_sum_std: float
    :param e_HP_imd_std:中間期-標準条件におけるヒートポンプのエネルギー消費効率
    :type e_HP_imd_std: float
    :param e_HP_win_std:冬期-標準条件におけるヒートポンプのエネルギー消費効率
    :type e_HP_win_std: float
    :param e_HP_frst_upper_cm:着霜領域（上限）-標準条件におけるヒートポンプのエネルギー消費効率
    :type e_HP_frst_upper_cm: float
    :param e_HP_frst_high:着霜期-高温条件におけるヒートポンプの除霜運転を除くエネルギー消費効率
    :type e_HP_frst_high: float
    :param e_HP_win_cd_high:寒冷地冬期-高温条件におけるヒートポンプの除霜運転を除くエネルギー消費効率
    :type e_HP_win_cd_high: float
    :param theta_hat_bw_sum_cm:制御モードcmの夏期条件におけるM1スタンダードモード沸き上げ温度
    :type theta_hat_bw_sum_cm: float
    :param theta_hat_bw_imd_cm:制御モードcmの中間期条件におけるM1スタンダードモード沸き上げ温度
    :type theta_hat_bw_imd_cm: float
    :param theta_hat_bw_win_cm:制御モードcmの冬期条件におけるM1スタンダードモード沸き上げ温度
    :type theta_hat_bw_win_cm: float
    :param theta_hat_bw_frst_cm:制御モードcmの着霜期条件におけるM1スタンダードモード沸き上げ温度
    :type theta_hat_bw_frst_cm: float
    :param theta_hat_bw_win_cd_cm:制御モードcmの寒冷地冬期条件におけるM1スタンダードモード沸き上げ温度
    :type theta_hat_bw_win_cd_cm: float
    :param theta_star_bw_std:標準条件の沸き上げ温度
    :type theta_star_bw_std: float
    :param theta_star_bw_high:高温条件の沸き上げ温度
    :type theta_star_bw_high: float

    :return: ヒートポンプのM1スタンダードモードエネルギー消費効率
    :rtype: tuple
    """
    # (8a)
...
def get_e_HP_std(theta_bw_sum_std_test, theta_bw_imd_std_test, theta_bw_win_std_test, theta_star_bw_std, theta_star_ex_imd,
    ...
    :param theta_bw_sum_std_test:試験時の夏期標準加熱条件における沸き上げ温度
    :type theta_bw_sum_std_test: float
    :param theta_bw_imd_std_test:試験時の中間期標準加熱条件における沸き上げ温度
    :type theta_bw_imd_std_test: float
    :param theta_bw_win_std_test:試験時の冬期標準加熱条件における沸き上げ温度
    :type theta_bw_win_std_test: float
    :param theta_star_bw_std:標準条件の沸き上げ温度
    :type theta_star_bw_std: float
    :param theta_star_ex_imd:中間期条件の外気温度
    :type theta_star_ex_imd: float
    ...
    :param theta_star_bw_high:高温条件の沸き上げ温度
    :type theta_star_bw_high: float
    :param theta_bw_frst_high_test:試験時の着霜期高温加熱条件における沸き上げ温度
    :type theta_bw_frst_high_test: float
    :param e_HP_sum_std_test:試験時の夏期標準加熱条件におけるヒートポンプのエネルギー消費効率
    :type e_HP_sum_std_test: float
    :param e_HP_imd_std_test:試験時の中間期標準加熱条件におけるヒートポンプのエネルギー消費効率
    :type e_HP_imd_std_test: float
    :param e_HP_win_std_test:試験時の冬期標準加熱条件におけるヒートポンプのエネルギー消費効率
    :type e_HP_win_std_test: float
    :param e_HP_frst_high_test:試験時の着霜期高温加熱条件におけるヒートポンプの除霜運転を除くエネルギー消費効率
    :type e_HP_frst_high_test: float
    :return: 沸き上げ温度を標準条件または高温条件とした場合のヒートポンプのエネルギー消費効率
    :rtype: tuple
    """
...
def get_e_HP_std_test(q_HP_sum_std_test, q_HP_imd_std_test, q_HP_win_std_test,
    ...
    :param q_HP_sum_std_test:試験時の夏期標準加熱条件におけるヒートポンプの加熱能力
    :type q_HP_sum_std_test: float
    :param q_HP_imd_std_test:試験時の中間期標準加熱条件におけるヒートポンプの加熱能力
    :type q_HP_imd_std_test: float
    :param q_HP_win_std_test:試験時の冬期標準加熱条件におけるヒートポンプの加熱能力
    :type q_HP_win_std_test: float
    :param P_HP_sum_std_test:試験時の夏期標準加熱条件におけるヒートポンプの消費電力
    :type P_HP_sum_std_test: float
    :param P_HP_imd_std_test:試験時の中間期標準加熱条件におけるヒートポンプの消費電力
    :type P_HP_imd_std_test: float
    :param P_HP_win_std_test:試験時の冬期標準加熱条件におけるヒートポンプの消費電力
    :type P_HP_win_std_test: float
    :return: 試験時のヒートポンプのエネルギー消費効率
    :rtype: tuple
    """
...
def get_q_HP_cm_d(e_HP_cm_d, P_HP_cm_d):
    ...
    :param e_HP_cm_d:日付dにおける制御モードcmのヒートポンプのエネルギー消費効率
    :type e_HP_cm_d: ndarray
    :param P_HP_cm_d:日付dにおける制御モードcmのヒートポンプの消費電力
    :type P_HP_cm_d: ndarray
    :return: 付dにおける制御モードcmのヒートポンプの加熱能力
    :rtype: ndarray
    """
...
def get_P_HP_cm_d(q_HP_sum_std_test, q_HP_win_std_test, A_p, B_p, theta_hat_bw_cm_d, theta_ex_Nave_d,
    ...
    :param q_HP_win_std_test:試験時の冬期標準加熱条件におけるヒートポンプの加熱能力
    :type q_HP_win_std_test: float
    :param A_p:ヒートポンプの消費電力を求める回帰式の傾き
    :type A_p: float
    :param B_p:ヒートポンプの消費電力を求める回帰式の切片（kW）
    :type B_p: float
    :param theta_hat_bw_cm_d:日付dにおける制御モードcmのM1スタンダードモード沸き上げ温度
    :type theta_hat_bw_cm_d: float
    :param theta_ex_Nave_d:日付dにおける夜間平均外気温度
    :type theta_ex_Nave_d: float
    :param theta_star_bw_std:標準条件の沸き上げ温度
    :type theta_star_bw_std: float
    :param theta_star_ex_sum:夏期条件の外気温度
    :type theta_star_ex_sum: float
    :param P_HP_sum_std_test:試験時の夏期標準加熱条件におけるヒートポンプの消費電力
    :type P_HP_sum_std_test: float
    :return: 日付dにおける制御モードcmのヒートポンプの消費電力
    :rtype: ndarray
    """
...
def get_C_def_cm_d(theta_star_ex_frst_upper, theta_ex_Nave_d, theta_star_ex_frst, theta_star_ex_frst_imd,
    ...
    :param theta_star_ex_frst:着霜期条件の外気温度
    :type theta_star_ex_frst: float
    :param theta_star_ex_frst_imd:着霜領域（中間）の外気温度
    :type theta_star_ex_frst_imd: float
    :param theta_star_ex_win_cd:寒冷地冬期条件の外気温度
    :type theta_star_ex_win_cd: float
    :param C_def_frst_cm:着霜期条件における除霜効率係数
    :type C_def_frst_cm: float
    :param C_def_win_cd_cm:寒冷地冬期条件における除霜効率係数
    :type C_def_win_cd_cm: float
    :return: 日付dにおける制御モードcmの除霜効率係数
    :rtype: ndarray
    """
...
def get_C_def_frst_cm(theta_hat_bw_frst_cm, theta_bw_frst_high_test, C_def_frst_test):
    ...
    :param theta_bw_frst_high_test: 試験時の着霜期高温加熱条件における沸き上げ温度
    :type theta_bw_frst_high_test: float
    :param C_def_frst_test: 試験時の着霜期高温条件における除霜効率係数
    :type C_def_frst_test: float
    :return: 試験時の着霜期高温条件における除霜効率係数
    :rtype: float
    """
...
def get_C_def_frst_test(e_HP_def_high_test, e_HP_frst_high_test):
    ...
    :param e_HP_def_high_test:試験時の着霜期高温加熱条件におけるヒートポンプの除霜運転を含むエネルギー消費効率
    :type e_HP_def_high_test: float
    :param e_HP_frst_high_test:試験時の着霜期高温加熱条件におけるヒートポンプの除霜運転を除くエネルギー消費効率
    :type e_HP_frst_high_test: float
    :return: 試験時の着霜期高温条件における除霜効率係数
    :rtype: float
...
def get_tau_HP_cm_d_t(t_HP_stop, t_HP_start_d, tau_dot_HP_cm_d):
    ...
    :param t_HP_stop:沸き上げ終了時刻
    :type t_HP_stop: float
    :param t_HP_start_d:日付dの時刻tにおける制御モードcmの1時間当たりのヒートポンプ運転時間
    :type t_HP_start_d: ndarray
    :param t_HP_start_d:日付dにおける制御モードcmの1日当たりのヒートポンプ運転時間
    :type t_HP_start_d: ndarray
    :return: 日付dの時刻tにおける制御モードcmの1時間当たりのヒートポンプ運転時間
    :rtype: ndarray
    """
...
def get_t_HP_start_d(t_HP_stop, tau_dot_HP_cm_d):
    ...
    :param Q_dot_HP_cm_d:沸き上げ終了時刻
    :type Q_dot_HP_cm_d: ndarray
    :param q_HP_cm_d:日付dにおける制御モードcmの1日当たりのヒートポンプ運転時間
    :type q_HP_cm_d: ndarray
    :return: 日付dに沸き上げが終了する運転の沸き上げ開始時刻
    :rtype: ndarray
    """
...
def get_tau_dot_HP_cm_d(Q_dot_HP_cm_d, q_HP_cm_d):
    ...
    :param Q_dot_HP_cm_d:日付dにおける制御モードcmの1日当たりの沸き上げ熱量
    :type Q_dot_HP_cm_d: ndarray
    :param q_HP_cm_d:日付dにおける制御モードcmのヒートポンプの加熱能力
    :type q_HP_cm_d: ndarray
    :return: 日付dにおける制御モードcmの1日当たりのヒートポンプ運転時間
    :rtype: ndarray
    """
...
def get_Q_dot_HP_cm_d(L_dashdash_d, Q_dot_loss_cm_d):
    ...
    :param L_dashdash_d:日付dにおける1日当たりの太陽熱補正給湯熱負荷
    :type L_dashdash_d: ndarray
    :param Q_dot_loss_cm_d:日付dにおける制御モードcmの1日当たりの貯湯熱損失量
    :type Q_dot_loss_cm_d: ndarray
    :return: 日付dにおける制御モードcmの1日当たりの沸き上げ熱量
    :rtype: ndarray
    """
...
def get_Q_dot_loss_cm_d(theta_tnk_eq_cm_d, theta_ex_d_Ave_d, R_tnk_test):
    ...
    :param theta_tnk_eq_cm_d:日付dにおける制御モードcmの等価貯湯温度
    :type theta_tnk_eq_cm_d: ndarray
    :param theta_ex_d_Ave_d:日付dにおける日平均外気温度
    :type theta_ex_d_Ave_d: ndarray
    :param R_tnk_test:貯湯タンク総括熱抵抗
    :type R_tnk_test: float
    :return: 日付dにおける制御モードcmの1日当たりの貯湯熱損失量
    :rtype: ndarray
    """
...
def get_theta_tnk_eq_cm1_d(theta_ex_d_Ave_d, theta_star_ex_frst, theta_star_ex_frst_upper, theta_tnk_eq_win,
    ...
    :param theta_star_ex_frst_upper:着霜領域（上限）の外気温度
    :type theta_star_ex_frst_upper: float
    :param theta_tnk_eq_win:冬期条件における等価貯湯温度
    :type theta_tnk_eq_win: float
    :param theta_tnk_eq_frst:着霜期条件における等価貯湯温度
    :type theta_tnk_eq_frst: float
    :param theta_tnk_eq_frst_upper:着霜領域（上限）における等価貯湯温度
    :type theta_tnk_eq_frst_upper: float
    :return: 日付dにおける制御モードcmの等価貯湯温度
    :rtype: ndarray
    """
...
def get_theta_tnk_eq_cm2_d(theta_ex_d_Ave_d, theta_tnk_eq_cm1_d, theta_hat_bw_cm1_d, theta_hat_bw_cm2_d):
    ...
    :param theta_ex_d_Ave_d:日付dにおける日平均外気温度
    :type theta_ex_d_Ave_d: ndarray
    :param theta_tnk_eq_cm1_d:日付dにおけるファーストモードcmの等価貯湯温度
    :type theta_tnk_eq_cm1_d: ndarray
    :param theta_hat_bw_cm1_d:日付dにおけるファーストモードのM1スタンダードモード沸き上げ温度
    :type theta_hat_bw_cm1_d: ndarray
    :param theta_hat_bw_cm2_d:日付dにおけるセカンドモードのM1スタンダードモード沸き上げ温度
    :type theta_hat_bw_cm2_d: ndarray
    :return: 日付dにおける制御モードcmの等価貯湯温度
    :rtype: ndarray
    """
...
def get_theta_tnk_eq(theta_tnk_eq_test):
    ...
    :param theta_tnk_eq_test:試験時の等価貯湯温度
    :type theta_tnk_eq_test: float
    :return: 冬期条件、着霜期条件および着霜領域（上限）における等価貯湯温度
    :rtype: tuple
    """
    # 冬期条件における等価貯湯温度(23a)
...
def get_theta_tnk_eq_test(Q_loss_test, R_tnk_test, theta_star_ex_win):
    ...
    :param Q_loss_test:試験時の貯湯熱損失量
    :type Q_loss_test: float
    :param R_tnk_test:貯湯タンク総括熱抵抗
    :type R_tnk_test: float
    :param theta_star_ex_win:冬期条件の外気温度
    :type theta_star_ex_win: float
...
def get_E_E_aux_cm_d_t(P_aux_HP_on_test, P_aux_HP_off_test, tau_HP_cm_d_t):
    ...
    :param theta_hat_bw_win_cm:試験時のヒートポンプ停止時における補機の消費電力
    :type theta_hat_bw_win_cm: float
    :param theta_hat_bw_frst_cm:試験時のヒートポンプ運転時における補機の消費電力
    :type theta_hat_bw_frst_cm: float
    :param theta_hat_bw_win_cd_cm:日付dの時刻tにおける制御モードcmの1時間当たりのヒートポンプ運転時間
    :type theta_hat_bw_win_cd_cm: ndarray
    :return: 日付dにおける制御モードcmの1日当たりの補機の消費電力量
    :rtype: ndarray
    """
...
def get_theta_hat_bw_cm_d(theta_star_ex_imd, theta_star_ex_win, theta_star_ex_frst, theta_star_ex_win_cd,
    ...
    :param theta_hat_bw_win_cd_cm:制御モードcmの寒冷地冬期条件におけるM1スタンダードモード沸き上げ温度
    :type theta_hat_bw_win_cd_cm: float
    :return: 日付dにおける制御モードcmのM1スタンダードモード沸き上げ温度
    :rtype: ndarray
    """
...
def get_theta_hat_bw_sum_cm1(theta_star_bw_std):
    ...
    :param theta_star_bw_std: 標準条件の沸き上げ温度（
    :type theta_star_bw_std: float
    :return: 制御モードcmの夏期条件におけるM1スタンダードモード沸き上げ温度（
    :rtype: float
    """
    # 制御モードがファーストモードの場合
...
def get_theta_hat_bw_imd_cm1(theta_star_bw_std):
    ...
    :param theta_star_bw_std: 標準条件の沸き上げ温度（
    :type theta_star_bw_std: float
    :return: 制御モードcmの中間条件におけるM1スタンダードモード沸き上げ温度（
    :rtype: float
    """
    # 制御モードがファーストモードの場合
    return theta_star_bw_std
...
def get_theta_hat_bw_win_cm1(theta_star_bw_std, theta_hat_bw_win_cm1_test):
    ...
    :param theta_star_bw_std: 標準条件の沸き上げ温度（
    :type theta_star_bw_std: float
    :param theta_hat_bw_win_cm1_test: 試験時の制御モードがファーストモードの場合の冬期条件におけるM1スタンダードモード沸き上げ温度
    :type theta_hat_bw_win_cm1_test: float
    :return: 制御モードcmの冬期条件におけるM1スタンダードモード沸き上げ温度（
    :rtype: float
    """
    # 制御モードがファーストモードの場合
...
def get_theta_hat_bw_frst_cm1(theta_star_bw_high, theta_hat_bw_win_cm1):
    ...
    :param theta_star_bw_high: 高温条件の沸き上げ温度（
    :type theta_star_bw_high: float
    :param theta_hat_bw_win_cm1: 制御モードがファーストモードの場合の冬期条件におけるM1スタンダードモード沸き上げ温度
    :type theta_hat_bw_win_cm1: float
    :return: 制御モードcmの着霜期条件におけるM1スタンダードモード沸き上げ温度
    :rtype: float
    """
    # 制御モードがファーストモードの場合
...
def get_theta_hat_bw_win_cd_cm1(theta_star_bw_high, theta_hat_bw_win_cm1):
    ...
    :param theta_star_bw_high: 高温条件の沸き上げ温度（
    :type theta_star_bw_high: float
    :return: 制御モードcmの寒冷地冬期条件におけるM1スタンダードモード沸き上げ温度
    :rtype: float
    """
    # 制御モードがファーストモードの場合
...
def get_theta_hat_bw_sum_cm2(theta_hat_bw_sum_cm1, theta_hat_bw_win_cm1, theta_hat_bw_win_cm2):
    ...
    :param theta_hat_bw_sum_cm1: 制御モードがファーストモードの場合の夏期条件におけるM1スタンダードモード沸き上げ温度
    :type theta_hat_bw_sum_cm1: float
    :param theta_hat_bw_win_cm1: 制御モードがファーストモードの場合の冬期条件におけるM1スタンダードモード沸き上げ温度
    :type theta_hat_bw_win_cm1: float
    :param theta_hat_bw_win_cm2: 制御モードがセカンドモードの場合の冬期条件におけるM1スタンダードモード沸き上げ温度
    :type theta_hat_bw_win_cm2: float
    :return: 制御モードcmの寒冷地冬期条件におけるM1スタンダードモード沸き上げ温度
    :rtype: float
    """
    # 制御モードがセカンドモードの場合
...
def get_theta_hat_bw_imd_cm2(theta_hat_bw_imd_cm1, theta_hat_bw_win_cm1, theta_hat_bw_win_cm2):
    ...
    :param theta_hat_bw_imd_cm1: 制御モードがファーストモードの場合の中間期条件におけるM1スタンダードモード沸き上げ温度
    :type theta_hat_bw_imd_cm1: float
    :param theta_hat_bw_win_cm1: 制御モードがファーストモードの場合の冬期条件におけるM1スタンダードモード沸き上げ温度
    :type theta_hat_bw_win_cm1: float
    :param theta_hat_bw_win_cm2: 制御モードがセカンドモードの場合の冬期条件におけるM1スタンダードモード沸き上げ温度
    :type theta_hat_bw_win_cm2: float
...
def get_theta_hat_bw_win_cm2(theta_hat_bw_win_cm1, theta_hat_bw_win_cm1_test, theta_hat_bw_win_cm2_test):
    ...
    :param theta_hat_bw_win_cm1_test: 試験時の制御モードがファーストモードの場合の冬期条件におけるM1スタンダードモード沸き上げ温度
    :type theta_hat_bw_win_cm1_test: float
    :param theta_hat_bw_win_cm2_test: 試験時の制御モードがセカンドモードの場合の冬期条件におけるM1スタンダードモード沸き上げ温度
    :type theta_hat_bw_win_cm2_test: float
    :return: 制御モードcmの冬期条件におけるM1スタンダードモード沸き上げ温度（
    :rtype: float
    """
...
def get_theta_hat_bw_frst_cm2(theta_star_bw_high, theta_hat_bw_frst_cm1, theta_hat_bw_win_cm1, theta_hat_bw_win_cm2):
    ...
    :param theta_star_bw_high: 高温条件の沸き上げ温度（
    :type theta_star_bw_high: float
    :param theta_hat_bw_frst_cm1: 制御モードがファーストモードの場合の着霜期条件におけるM1スタンダードモード沸き上げ温度
    :type theta_hat_bw_frst_cm1: float
    :param theta_hat_bw_win_cm1: 制御モードがファーストモードの場合の冬期条件におけるM1スタンダードモード沸き上げ温度
    :type theta_hat_bw_win_cm1: float
    :param theta_hat_bw_win_cm2: 制御モードがセカンドモードの場合の冬期条件におけるM1スタンダードモード沸き上げ温度
    :type theta_hat_bw_win_cm2: float
...
def get_theta_hat_bw_win_cd_cm2(theta_star_bw_high, theta_hat_bw_win_cd_cm1, theta_hat_bw_win_cm1, theta_hat_bw_win_cm2):
    ...
    :param theta_star_bw_high: 高温条件の沸き上げ温度（
    :type theta_star_bw_high: float
    :param theta_hat_bw_win_cd_cm1: 制御モードがファーストモードの場合の寒冷地冬期条件におけるM1スタンダードモード沸き上げ温度
    :type theta_hat_bw_win_cd_cm1: float
    :param theta_hat_bw_win_cm1: 制御モードがファーストモードの場合の冬期条件におけるM1スタンダードモード沸き上げ温度
    :type theta_hat_bw_win_cm1: float
    :param theta_hat_bw_win_cm2: 制御モードがセカンドモードの場合の冬期条件におけるM1スタンダードモード沸き上げ温度
    :type theta_hat_bw_win_cm2: float
...
def get_delta_theta_hat_star_bw_win_test():
    ...
    :return: 試験時のファーストモードの冬期条件におけるM1スタンダードモード沸き上げ温度とセカンドモードの冬期条件におけるM1スタンダードモード沸き上げ温度の差の最小値
    :rtype: float
    """
    return 5
...
def get_table_3_b():
    ...
    :return: 表3（b） 給湯機の仕様の決定方法（当該給湯機の効率に応じて定まる数値を用いる場合）
    :rtype: list
    """
    # 表3（b） 給湯機の仕様の決定方法（当該給湯機の効率に応じて定まる数値を用いる場合）
    table_3_b = [
