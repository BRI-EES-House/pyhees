...
def get_C_E_def_d(theta_ex_d_Ave_d):
    ...
    :param theta_ex_d_Ave_d: 日平均外気温度 (℃)
    :type: ndarray
    :return: 1日当たりのデフロスト運転による消費電力量の補正係数 (3)
    :rtype: ndarray
    """
...
def get_C_G_def_d(theta_ex_d_Ave_d):
    ...
    :param theta_ex_d_Ave_d: 日平均外気温度 (℃)
    :type theta_ex_d_Ave_d: ndarray
    :return: 1日当たりのデフロスト運転によるガス消費量の補正係数 (7)
    :rtype: ndarray
    """
    C_G_def = np.ones(365)
