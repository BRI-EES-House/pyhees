...
def calc_U_A(envelope):
    ...
    :param envelope: Envelope要素のノード名をkey、値をvalueとして持つ辞書
    :type envelope: dict(Envelope)
    :return: 外皮平均熱貫流率, envelopeに計算結果を付加した辞書
    :rtype: float, dict
    """
...
def calc_eta_A_H(envelope):
    ...
    :param envelope: Envelope要素のノード名をkey、値をvalueとして持つ辞書
    :type envelope: dict(Envelope)
    :return: 暖房期の平均日射熱取得率, envelopeに計算結果を付加した辞書
    :rtype: float, dict
    """
...
def calc_eta_A_C(envelope):
    ...
    :param envelope: Envelope要素のノード名をkey、値をvalueとして持つ辞書
    :type envelope: dict(Envelope)
    :return: 冷房期の平均日射熱取得率, envelopeに計算結果を付加した辞書
    :rtype: float, dict
    """
...
def get_component_byName(wall_list, componentname):
    ...
    :param wall_list: 窓を除く外皮等のリスト
    :type wall_list: List<dict>(Wall_direct Wall_accurate Wall_simple Wall_rc Wall_steel)
    :param componentname: 部位の名前
    :param componentname: str
    :return: 部位のパラメータを持つ辞書
    :rtype: dict(Wall_direct Wall_accurate Wall_simple Wall_rc Wall_steel)
    """
