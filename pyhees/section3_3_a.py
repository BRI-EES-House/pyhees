...
def calc_R_si_R_se(part, Outside):
    ...
    :param part: 'Roof'(屋根)または'Ceiling'(天井)または'ExternalWall'(外壁)または'Floor'(床)または
                    'BoundaryWall'(界壁)または'BoundaryCeiling'(上階側界床)または'BoundaryFloor'(下階側界床)
    :type part: str
    :param Outside: 室外側は外気かどうか
                    'Yes'または'No'
    :type Outside: str
    :return: 熱的境界内側の表面熱伝達抵抗（m2K/W）, 熱的境界外側の表面熱伝達抵抗（m2K/W）
    :rtype: tuple
    """
...
def get_table_3_1(part, Outside):
    ...
    :param part: 'Roof'(屋根)または'Ceiling'(天井)または'ExternalWall'(外壁)または'Floor'(床)
    :type part: str
    :param Outside: 室外側は外気かどうか
                    'Yes'または'No'
    :type Outside: str
    :return: 熱的境界内側（室内側）の表面熱伝達抵抗（m2K/W）, 熱的境界外側（外気側）の表面熱伝達抵抗（m2K/W）
    :rtype: tuple
    """
...
def get_table_3_2(part):
    ...
    :param part: 'BoundaryWall'(界壁)または'BoundaryCeiling'(上階側界床)または'BoundaryFloor'(下階側界床)
    :type part: str
    :return: 対象住戸の室内側表面熱伝達抵抗（m2K/W）, 隣接住戸の室内側表面熱伝達抵抗（m2K/W）
    :rtype: tuple
    """
