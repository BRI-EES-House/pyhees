...
def get_value(CG_category, index):
    ...
    :type CG_category: str
    :param index: 表A.1における番号
    :type index: int
    :return: 表A.1から読み取った値
    :rtype: bool
    :rtype: str
...
def get_exhaust(CG_category):
    ...
    :param CG_category: コージェネレーション設備の種類 コージェネレーション設備の種類
    :type CG_category: str
    :return: 温水暖房への排熱利用
    :rtype: bool
    """
...
def get_param_E_E_gen_PU_EVt_d(CG_category):
    ...
    :param CG_category: コージェネレーション設備の種類 
    :type CG_category: str
    :return: 発電ユニットの発電量推定時の仮想発電量のパラメータ a_PU, a_DHW, a_HWH, b, c
    :rtype: dict
    """
    return {
...
def get_param_E_F_PU_HVt_d(CG_category):
    ...
    :param CG_category: コージェネレーション設備の種類 
    :type CG_category: str
    :return: 発電ユニットの排熱量推定時の仮想燃料消費量を求める係数 a_DHW, a_HWH
    :rtype: dict
    """
    return {
...
def get_param_r_H_gen_PU_HVt_d(CG_category):
    ...
    :param CG_category: コージェネレーション設備の種類 
    :type CG_category: str
    :return: 発電ユニットの排熱量推定時の仮想排熱量の上限比を求める係数 a_DHW, a_HWH, b
    :rtype: dict
    """
    return {
...
def get_param_e_E_PU_d(CG_category):
    ...
    :param CG_category: コージェネレーション設備の種類 
    :type CG_category: str
    :return: 発電ユニットの日平均発電効率を求める係数 a_PU, a_DHW, a_HWH, b, 上限値, 下限値
    :rtype: dict
    """
    return {
...
def get_param_e_H_PU_d(CG_category):
    ...
    :param CG_category: コージェネレーション設備の種類 
    :type CG_category: str
    :return: 発電ユニットの日平均排熱効率を求める係数 a_PU, a_DHW, a_HWH, b, 上限値, 下限値
    :rtype: dict
    """
    return {
