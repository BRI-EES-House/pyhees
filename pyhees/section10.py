...
def calc_E_E_AP_d_t(n_p):
    ...
    :param n_p: 仮想居住人数 仮想居住人数 
    :tyoe n_p: float 
    :return: 1 時間当たりの家電の消費電力量
    :rtype: ndarray
    """
...
def get_E_M_AP_d_t():
    ...
    :return: 1 時間当たりの家電のその他の燃料による一次エネルギー消費量
    :rtype: ndarray
    """
    return np.zeros(24 * 365)
...
def get_E_M_CC_d_t():
    ...
    :return: 1 時間当たりの調理のその他の燃料による一次エネルギー消費量
    :rtype: ndarray
    """
    return np.zeros(24 * 365)
...
def get_E_E_AP_p_d_t(p, schedule_app):
    ...
    :param p: 居住人数
    :type p: float
    :param schedule_app: 家電スケジュール
    :type schedule_app: ndarray
    :return: 1 時間当たりの居住人数がp人における家電の消費電力量
    :rtype: ndarray
    """
    # 平日
...
def get_E_G_CC_p_d_t(p, schedule_cc):
    ...
    :param p: 居住人数
    :type p: float
    :param schedule_cc: 調理スケジュール
    :type schedule_cc: ndarray
    :return: 1 時間当たりの居住人数がp人における調理のガス消費量
    :rtype: ndarray
    """
    # 平日
...
def get_table_a_1():
    ...
    :return: 表 A.1 家電による 1 時間当たりの消費電力量
    :rtype: list
    """
    table_a_1 = [
...
def get_table_a_2():
    ...
    :return: 表 A.2 調理による 1 時間当たりのガス消費量
    :rtype: list
    """
    table_a_2 = [
