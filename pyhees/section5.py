...
def calc_E_E_V_d_t(n_p, A_A, V, HEX=None):
    ...
    :type HEX: dict
    :return: E_E_V_d_t 日付dの時刻tにおける1時間当たりの機械換気設備の消費電力量[kWh/h]
    :rtype: ndarray
    """
    if V is None:
...
def calc_E_E_VG_d_t(f_SFP_d_t, A_A, N, e):
    ...
    :param f_SFP_d_t: 日付dの時刻tにおける全般換気設備の比消費電力[W/(m^3/h)]
    :type f_SFP_d_t: ndarray
    :param A_A: 床面積の合計[m^2]
    :type A_A: float
    :param N: 換気回数[1/h]
    :type N: float
    :param e: 有効換気量率
    :type e: float
    :return: E_E_VG_d_t 日付dの時刻tにおける1時間当たりの全般換気設備の消費電力量[kWh/h]
    :rtype: ndarray
    """
...
def calc_V_R(A_A, N, e):
    ...
    :param e: 有効換気量率
    :type e: float
    :return: V_R 全般換気設備の参照機械換気量[m^3/h]
    :rtype: float
    """
    H_R = get_H_R()
    a = get_a()
...
def get_f_SFP(P, V_d):
    ...
    :param P: 全般換気設備の消費電力[W]
    :type P: float
    :param V_d: 全般換気設備の設計風量[m^3/h]
    :type V_d: float
    :return: f_SEP　比消費電力[W/(m^3/h)]
    :rtype: float
    """
    f_SFP = P / V_d
...
def calc_E_E_VL_d_t(n_p, schedule_v):
    ...
    :param n_p: 仮想居住人数
    :type n_p: float
    :param schedule_v: 換気スケジュール
    :type schedule_v: ndarray
    :return: E_E_VL_d_t 日付𝑑の時刻𝑡における 1 時間当たりの局所換気設備の消費電力量[kWh/h]
    :rtype: ndarray
    """
    # (5)
    if 1 <= n_p and n_p <= 2:
...
def get_E_E_VL_p_d_t(p, schedule_v):
    ...
    :param schedule_v: 換気スケジュール
    :type schedule_v: ndarray
    :return: E_E_VL_p_d_t 日付𝑑の時刻𝑡における1時間当たりの居住人数が𝑝人における局所換気設備の消費電力量[kWh/h]
    :rtype: ndarray
    """
