...
# 第三章 暖冷房負荷と外皮性能
# 第五節 モデル共同住宅の外皮性能
# Ver.01（エネルギー消費性能計算プログラム（住宅版）Ver.2022.10～）
# ============================================================================
import math
from decimal import Decimal, ROUND_HALF_UP, ROUND_CEILING, ROUND_FLOOR

def get_U_A_f_i(q_f_i, A_env_f_i):
    """階層fにおける単位住戸iの外皮平均熱貫流率（W/m2K）…………式(1)

    Args:
      q_f_i(float): 階層fにおける単位住戸iの単位温度差当たりの熱損失量…………式(2)/get_q_f_i
      A_env_f_i(Decimal): 階層fにおける単位住戸iの外皮の部位の面積の合計…………式(5)/get_A_env_f_i
...
def get_q_f_i(A_roof_f_i, A_ceiling_f_i, A_ofloor_f_i, A_ufloor_f_i, A_ifloor_f_i, 
    ...
    """階層fにおける単位住戸iの単位温度差当たりの熱損失量…………式(2)

    Args:
      A_roof_f_i(float): 階層fにおける単位住戸iの屋根面積（m2）…………式(6)/get_A_roof_f_i
      A_ceiling_f_i(float): 階層fにおける単位住戸iの上階側界床面積（m2）…………式(7)/get_A_ceiling_f_i
      A_ofloor_f_i(float): 階層fにおける単位住戸iの外気に接する床面積（m2）…………式(14)/get_A_ofloor_f_i
      A_ufloor_f_i(float): 階層fにおける単位住戸iの外気に通じる床裏に接する床面積（m2）…………式(13)/get_A_ufloor_f_i
      A_ifloor_f_i(float): 階層fにおける単位住戸iの界床面積（m2）…………式(12)/get_A_ifloor_f_i
      A_owall_0_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した部位の外壁面積（m2）…………式(8a)/get_A_owall_0_f_i
      A_owall_90_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した部位の外壁面積（m2）…………式(8b)/get_A_owall_90_f_i
      A_owall_180_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに180°の方向に面した部位の外壁面積（m2）…………式(8c)/get_A_owall_180_f_i
      A_owall_270_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに270°の方向に面した部位の外壁面積（m2）…………式(8d)/get_A_owall_270_f_i
      A_iwall_0_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した部位の界壁面積（m2）…………式(9a)/get_A_iwall_0_f_i
      A_iwall_90_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した部位の界壁面積（m2）…………式(9b)/get_A_iwall_90_f_i
      A_iwall_180_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに180°の方向に面した部位の界壁面積（m2）…………式(9c)/get_A_iwall_180_f_i
      A_iwall_270_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに270°の方向に面した部位の界壁面積（m2）…………式(9d)/get_A_iwall_270_f_i
      A_window_0_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した部位の窓面積（m2）…………式(10a)/get_A_window_0_f_i
      A_window_90_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した部位の窓面積（m2）…………式(10b)/get_A_window_90_f_i
      A_window_180_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに180°の方向に面した部位の窓面積（m2）…………式(10c)/get_A_window_180_f_i
      A_window_270_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに270°の方向に面した部位の窓面積（m2）…………式(10d)/get_A_window_270_f_i
      A_door_0_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した部位の玄関ドアの面積（m2）…………式(11a)/get_A_door_0_f_i
      A_door_90_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した部位の玄関ドアの面積（m2）…………式(11b)/get_A_door_90_f_i
      A_door_180_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに180°の方向に面した部位の玄関ドアの面積（m2）…………式(11c)/get_A_door_180_f_i
      A_door_270_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに270°の方向に面した部位の玄関ドアの面積（m2）…………式(11d)/get_A_door_270_f_i
      ...
      L_HB_roof_owall_top_0_oc_f_i(float): 階層fにおける単位住戸iの屋根と主開口方位から時計回りに0°の方向に面した外壁の出隅部による熱橋の長さ（m）…………式(17a)/get_L_HB_roof_owall_top_0_oc_f_i
      L_HB_roof_owall_top_90_oc_f_i(float): 階層fにおける単位住戸iの屋根と主開口方位から時計回りに90°の方向に面した外壁の出隅部による熱橋の長さ（m）…………式(17b)/get_L_HB_roof_owall_top_90_oc_f_i
      L_HB_roof_owall_top_180_oc_f_i(float): 階層fにおける単位住戸iの屋根と主開口方位から時計回りに180°の方向に面した外壁の出隅部による熱橋の長さ（m）…………式(17c)/get_L_HB_roof_owall_top_180_oc_f_i
      L_HB_roof_owall_top_270_oc_f_i(float): 階層fにおける単位住戸iの屋根と主開口方位から時計回りに270°の方向に面した外壁の出隅部による熱橋の長さ（m）…………式(17d)/get_L_HB_roof_owall_top_270_oc_f_i
      L_HB_roof_owall_top_0_ic_t_f_i(float): 階層fにおける単位住戸iの屋根と主開口方位から時計回りに0°の方向に面した外壁の上部の入隅部による熱橋の長さ（m）…………式(18a)/get_L_HB_roof_owall_top_0_ic_t_f_i
      L_HB_roof_owall_top_0_ic_b_f_i(float): 階層fにおける単位住戸iの屋根と主開口方位から時計回りに0°の方向に面した外壁の下部の入隅部による熱橋の長さ（m）…………式(18b-1,2)get_L_HB_roof_owall_top_0_ic_b_f_i
      L_HB_roof_iwall_top_90_f_i(float): 階層fにおける単位住戸iの屋根と主開口方位から時計回りに90°の方向に面した界壁による熱橋の長さ（m）…………式(19a-1,2)/get_L_HB_roof_iwall_top_90_f_i
      L_HB_roof_iwall_top_270_f_i(float): 階層fにおける単位住戸iの屋根と主開口方位から時計回りに270°の方向に面した界壁による熱橋の長さ（m）…………式(19b-1,2)/get_L_HB_roof_iwall_top_270_f_i
      L_dash_HB_roof_iwall_top_90_f_i(float): 階層fにおける単位住戸iの屋根と主開口方位から時計回りに90°の方向に面した室内壁による熱橋の加算長さ（m）…………式(19c)/get_L_dash_HB_roof_iwall_top_90_f_i
      L_dash_HB_roof_iwall_top_0_f_i(float): 階層fにおける単位住戸iの屋根と主開口方位から時計回りに0°の方向に面した室内壁による熱橋の加算長さ（m）…………式(19d)/get_L_dash_HB_roof_iwall_top_0_f_i
      L_HB_owall_owall_0_90_f_i(float): 階層fにおける単位住戸iの主開口部方位から時計回りに0°及び90°の方位に面した外壁同士の熱橋の長さ（m）…………式(20a)/get_L_HB_owall_owall_0_90_f_i
      L_HB_owall_owall_90_180_f_i(float): 階層fにおける単位住戸iの主開口部方位から時計回りに90°及び180°の方位に面した外壁同士の熱橋の長さ（m）…………式(20b)/get_L_HB_owall_owall_90_180_f_i
      L_HB_owall_owall_180_270_f_i(float): 階層fにおける単位住戸iの主開口部方位から時計回りに180°及び270°の方位に面した外壁同士の熱橋の長さ（m）…………式(20c)/get_L_HB_owall_owall_180_270_f_i
      L_HB_owall_owall_270_0_f_i(float): 階層fにおける単位住戸iの主開口部方位から時計回りに270°及び0°の方位に面した外壁同士の熱橋の長さ（m）…………式(20d)/get_L_HB_owall_owall_270_0_f_i
      L_HB_owall_iwall_0_90_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した外壁と90°の方向に面した界壁による熱橋の長さ（m）…………式(21a-1,2)/get_L_HB_owall_iwall_0_90_f_i
      L_HB_owall_iwall_0_270_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した外壁と270°の方向に面した界壁による熱橋の長さ（m）…………式(21b-1,2)/get_L_HB_owall_iwall_0_270_f_i
      L_HB_owall_iwall_180_90_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに180°の方向に面した外壁と90°の方向に面した界壁による熱橋の長さ（m）…………式(21c-1,2)/get_L_HB_owall_iwall_180_90_f_i
      L_HB_owall_iwall_180_270_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに180°の方向に面した外壁と270°の方向に面した界壁による熱橋の長さ（m）…………式(21d-1,2)/get_L_HB_owall_iwall_180_270_f_i
      L_dash_HB_owall_iwall_0_90_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した外壁と90°の方向に面した室内壁による熱橋の加算長さ（m）…………式(21e)/get_L_dash_HB_owall_iwall_0_90_f_i
      L_dash_HB_owall_iwall_90_0_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した外壁と0°の方向に面した室内壁による熱橋の加算長さ（m）…………式(21f)/get_L_dash_HB_owall_iwall_90_0_f_i
      L_dash_HB_owall_iwall_180_90_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに180°の方向に面した外壁と90°の方向に面した室内壁による熱橋の加算長さ（m）…………式(21g)/get_L_dash_HB_owall_iwall_180_90_f_i
      L_dash_HB_owall_iwall_270_0_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに270°の方向に面した外壁と0°の方向に面した室内壁による熱橋の加算長さ（m）…………式(21h)/get_L_dash_HB_owall_iwall_270_0_f_i
      L_HB_owall_ifloor_0_bottom_t_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した外壁の上部と界床による熱橋の長さ（m）…………式(22a-1,2,3)/get_L_HB_owall_ifloor_0_bottom_t_f_i
      L_HB_owall_ifloor_0_bottom_b_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した外壁の下部と界床による熱橋の長さ（m）…………式(22b-1,2)/get_L_HB_owall_ifloor_0_bottom_b_f_i
      L_HB_owall_ifloor_90_bottom_t_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した外壁の上部と界床による熱橋の長さ（m）…………式(22c-1,2)/get_L_HB_owall_ifloor_90_bottom_t_f_i
      L_HB_owall_ifloor_90_bottom_b_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した外壁の下部と界床による熱橋の長さ（m）…………式(22d-1,2)/get_L_HB_owall_ifloor_90_bottom_b_f_i
      L_HB_owall_ifloor_180_bottom_t_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに180°の方向に面した外壁の上部と界床による熱橋の長さ（m）…………式(22e)/get_L_HB_owall_ifloor_180_bottom_t_f_i
      L_HB_owall_ifloor_180_bottom_b_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに180°の方向に面した外壁の下部と界床による熱橋の長さ（m）…………式(22f)/get_L_HB_owall_ifloor_180_bottom_b_f_i
      L_HB_owall_ifloor_270_bottom_t_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに270°の方向に面した外壁の上部と界床による熱橋の長さ（m）…………式(22g-1,2)/get_L_HB_owall_ifloor_270_bottom_t_f_i
      L_HB_owall_ifloor_270_bottom_b_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに270°の方向に面した外壁の下部と界床による熱橋の長さ（m）…………式(22h-1,2)/get_L_HB_owall_ifloor_270_bottom_b_f_i
      L_HB_owall_ofloor_0_bottom_oc_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した外壁と外気に接する床の出隅部による熱橋の長さ（m）…………式(24a)/get_L_HB_owall_ofloor_0_bottom_oc_f_i
      L_HB_owall_ofloor_90_bottom_oc_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した外壁と外気に接する床の出隅部による熱橋の長さ（m）…………式(24b)/get_L_HB_owall_ofloor_90_bottom_oc_f_i
      L_HB_owall_ofloor_180_bottom_oc_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに180°の方向に面した外壁と外気に接する床の出隅部による熱橋の長さ（m）…………式(24c)/get_L_HB_owall_ofloor_180_bottom_oc_f_i
      L_HB_owall_ofloor_270_bottom_oc_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに270°の方向に面した外壁と外気に接する床の出隅部による熱橋の長さ（m）…………式(24d)/get_L_HB_owall_ofloor_270_bottom_oc_f_i
      L_HB_owall_ofloor_0_bottom_ic_t_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した外壁の上部と外気に接する床の入隅部による熱橋の長さ（m）…………式(25a-1,2)/get_L_HB_owall_ofloor_0_bottom_ic_t_f_i
      L_HB_owall_ofloor_0_bottom_ic_b_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した外壁の下部と外気に接する床の入隅部による熱橋の長さ（m）…………式(25b)/get_L_HB_owall_ofloor_0_bottom_ic_b_f_i
      L_HB_owall_ufloor_0_bottom_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した外壁と外気に通じる床裏に接する床による熱橋の長さ（m）…………式(23a)/get_L_HB_owall_ufloor_0_bottom_f_i
      L_HB_owall_ufloor_90_bottom_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した外壁と外気に通じる床裏に接する床による熱橋の長さ（m）…………式(23b-1,2)/get_L_HB_owall_ufloor_90_bottom_f_i
      L_HB_owall_ufloor_180_bottom_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに180°の方向に面した外壁と外気に通じる床裏に接する床による熱橋の長さ（m）…………式(23c)/get_L_HB_owall_ufloor_180_bottom_f_i
      L_HB_owall_ufloor_270_bottom_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに270°の方向に面した外壁と外気に通じる床裏に接する床による熱橋の長さ（m）…………式(23d-1,2)/get_L_HB_owall_ufloor_270_bottom_f_i
      L_HB_iwall_ofloor_90_bottom_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した界壁と外気に接する床による熱橋の長さ（m）…………式(27a-1,2)/get_L_HB_iwall_ofloor_90_bottom_f_i
      L_HB_iwall_ufloor_90_bottom_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した界壁と外気に通じる床裏に接する床による熱橋の長さ（m）…………式(26a-1,2)/get_L_HB_iwall_ufloor_90_bottom_f_i
      L_HB_iwall_ufloor_270_bottom_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに270°の方向に面した界壁と外気に通じる床裏に接する床による熱橋の長さ（m）…………式(26b-1,2)/get_L_HB_iwall_ufloor_270_bottom_f_i
      L_dash_HB_iwall_ufloor_90_bottom_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した室内壁と外気に通じる床裏に接する床による熱橋の加算長さ（m）…………式(26c)/get_L_dash_HB_iwall_ufloor_90_bottom_f_i
      L_dash_HB_iwall_ufloor_0_bottom_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した室内壁と外気に通じる床裏に接する床による熱橋の加算長さ（m）…………式(26d)/get_L_dash_HB_iwall_ufloor_0_bottom_f_i
      L_HB_iwall_ofloor_270_bottom_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに270°の方向に面した界壁と外気に接する床による熱橋の長さ（m）…………式(27b-1,2)/get_L_HB_iwall_ofloor_270_bottom_f_i
      L_dash_HB_iwall_ofloor_90_bottom_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した室内壁と外気に接する床による熱橋の加算長さ（m）…………式(27c)/get_L_dash_HB_iwall_ofloor_90_bottom_f_i
      L_dash_HB_iwall_ofloor_0_bottom_f_i(float): 階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した室内壁と外気に接する床による熱橋の加算長さ（m）…………式(27d)/get_L_dash_HB_iwall_ofloor_0_bottom_f_i
...
def get_eta_A_H_f_i(m_H_f_i, A_env_f_i):
    """階層fにおける単位住戸iの暖房期の平均日射熱取得率（(W/m)/(W/m2)）(%) …………式(3a)

    Args:
      m_H_f_i(float): 階層fにおける単位住戸iの単位日射強度当たりの暖房期の日射熱取得量（W/(W/m2)）…………式(3b)/get_m_H_f_i
      A_env_f_i(Decimal): 階層fにおける単位住戸iの外皮の部位の面積の合計…………式(5)/get_A_env_f_i
...
def get_m_H_f_i(A_roof_f_i, A_owall_0_f_i, A_owall_90_f_i, A_owall_180_f_i, A_owall_270_f_i, 
    ...
    """階層fにおける単位住戸iの単位日射強度当たりの暖房期の日射熱取得量（W/(W/m2)）…………式(3b)
...
def get_eta_A_C_f_i(m_C_f_i, A_env_f_i):
    """階層fにおける単位住戸iの冷房期の平均日射熱取得率（(W/m)/(W/m2) (%) …………式(4a)

    Args:
      m_C_f_i(float): 階層fにおける単位住戸iの単位日射強度当たりの冷房期の日射熱取得量（W/(W/m2)）…………式(4b)/get_m_C_f_i
      A_env_f_i(Decimal): 階層fにおける単位住戸iの外皮の部位の面積の合計…………式(5)/get_A_env_f_i
...
def get_m_C_f_i(A_roof_f_i, A_owall_0_f_i, A_owall_90_f_i, A_owall_180_f_i, A_owall_270_f_i, 
    ...
    """階層fにおける単位住戸iの単位日射強度当たりの冷房期の日射熱取得量（W/(W/m2)）…………式(4b)
...
def get_A_roof_f_i(total_roof_area, dwelling_units):
    """階層fにおける単位住戸iの屋根面積…………式(6)

    Args:
      total_roof_area(float): 階層fにおける単位住戸の屋根面積の合計（m2）…………式(30)/get_total_roof_area
...
def get_A_owall_0_f_i(l_frnt_total_f, H_f, A_window_0_total_f, dwelling_units):
    """階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した部位の外壁面積（m2）…………式(8a)

    Args:
      l_frnt_total_f(float): 階層fにおける住棟の間口方向に面した住戸部分全体の外周の辺の長さ（m）…………式(29a)/get_l_frnt_total_f
      H_f(float): 階層fにおける階高（m）…………式(28)/get_H_f
      A_window_0_total_f(float): 階層fにおける単位住戸の主開口方位から時計回りに0°の方向に面した部位の窓面積の合計（m2）…………式(31a)/get_A_window_0_total_f
      dwelling_units(float): 階層fにおける単位住戸iの総数（-）…………入力1.2(2)11
...
def get_A_owall_90_f_i(l_dpth_total_f, H_f, A_window_90_total_f, i):
    """階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した部位の外壁面積（m2）…………式(8b)

    Args:
      l_dpth_total_f(float): 階層fにおける住棟の奥行き方向に面した住戸部分全体の外周の辺の長さ（m）…………式(29b)/get_l_dpth_total_f
      H_f(float): 階層fにおける階高（m）…………式(28)/get_H_f
      A_window_90_total_f(float): 階層fにおける単位住戸の主開口方位から時計回りに90°の方向に面した部位の窓面積の合計（m2）…………式(31b)/get_A_window_90_total_f
      i(int): 単位住戸
...
def get_A_owall_180_f_i(l_frnt_total_f, H_f, A_window_180_total_f, A_door_180_f_i, dwelling_units):
    """階層fにおける単位住戸iの主開口方位から時計回りに180°の方向に面した部位の外壁面積（m2）…………式(8c)

    Args:
      l_frnt_total_f(float): 階層fにおける住棟の間口方向に面した住戸部分全体の外周の辺の長さ（m）…………式(29a)/get_l_frnt_total_f
      H_f(float): 階層fにおける階高（m）…………式(28)/get_H_f
      A_window_180_total_f(float): 階層fにおける単位住戸の主開口方位から時計回りに180°の方向に面した部位の窓面積の合計（m2）…………式(31c)/get_A_window_180_total_f
      A_door_180_f_i(float): 階層fにおける単位住戸の主開口方位から時計回りに180°の方向に面した部位の窓面積の合計（m2）…………式(11c)
      dwelling_units(float): 階層fにおける単位住戸iの総数（-）…………入力1.2(2)11
...
def get_A_owall_270_f_i(l_dpth_total_f, H_f, A_window_270_total_f, i, dwelling_units):
    """階層fにおける単位住戸iの主開口方位から時計回りに270°の方向に面した部位の外壁面積（m2）…………式(8d)

    Args:
      l_dpth_total_f(float): 階層fにおける住棟の奥行き方向に面した住戸部分全体の外周の辺の長さ（m）…………式(29b)/get_l_dpth_total_f
      H_f(float): 階層fにおける階高（m）…………式(28)/get_H_f
      A_window_270_total_f(float): 階層fにおける単位住戸の主開口方位から時計回りに270°の方向に面した部位の窓面積の合計（m2）…………式(31d)/get_A_window_270_total_f
      i(int): 単位住戸
      dwelling_units(float): 階層fにおける単位住戸iの総数（-）…………入力1.2(2)11
...
def get_A_iwall_0_f_i():
    """階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した界壁面積（m2）…………式(9a)
...
def get_A_iwall_90_f_i(l_dpth_total_f, H_f, i):
    """階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した界壁面積（m2）…………式(9b)
...
def get_A_iwall_180_f_i():
    """階層fにおける単位住戸iの主開口方位から時計回りに180°の方向に面した界壁面積（m2）…………式(9c)
...
def get_A_iwall_270_f_i(l_dpth_total_f, H_f, i, dwelling_units):
    """階層fにおける単位住戸iの主開口方位から時計回りに270°の方向に面した界壁面積（m2）…………式(9d)
...
def get_A_window_0_f_i(A_window_0_total_f, dwelling_units):
    """階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した部位の窓面積…………式(10a)
...
def get_A_window_90_f_i(A_window_90_total_f, i):
    """階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した部位の窓面積…………式(10b)
...
def get_A_window_180_f_i(A_window_180_total_f, dwelling_units):
    """階層fにおける単位住戸iの主開口方位から時計回りに180°の方向に面した部位の窓面積…………式(10c)
...
def get_A_window_270_f_i(A_window_270_total_f, i, dwelling_units):
    """階層fにおける単位住戸iの主開口方位から時計回りに270°の方向に面した部位の窓面積…………式(10d)
...
def get_A_door_0_f_i():
    """階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した玄関ドア面積…………式(11a)
...
def get_A_door_90_f_i():
    """階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した玄関ドア面積…………式(11b)
...
def get_A_door_180_f_i():
    """階層fにおける単位住戸iの主開口方位から時計回りに180°の方向に面した玄関ドア面積…………式(11c)
...
def get_A_door_270_f_i():
    """階層fにおける単位住戸iの主開口方位から時計回りに270°の方向に面した玄関ドア面積…………式(11d)
...
def get_A_ifloor_f_i(A_ifloor_total_f, dwelling_units):
    """階層fにおける単位住戸iの界床面積（m2）…………式(12)

    Args:
      A_ifloor_total_f(float): 階層fにおける単位住戸の界床面積の合計（m2）…………式(32)/get_A_ifloor_total_f
      dwelling_units(float): 階層fにおける単位住戸iの総数（-）…………入力1.2(2)11
...
def get_A_ufloor_f_i(A_ufloor_total_f, dwelling_units):
    """階層fにおける単位住戸iの外気に通じる床裏に接する床面積（m2）…………式(13)

    Args:
      A_ufloor_total_f(float): 階層fにおける単位住戸の外気に通じる床裏に接する床面積の合計（m2）…………式(33)/get_A_ufloor_total_f
      dwelling_units(float): 階層fにおける単位住戸iの総数（-）…………入力1.2(2)11
...
def get_A_MR_f_i(A_floor_f_i, has_other_room):
    """階層fにおける単位住戸iの主たる居室の床面積…………式(16a)

    Args:
      A_floor_f_i(Decimal): 階層fにおける単位住戸iの床面積（m2）…………式(15)/get_A_floor_f_i
...
def get_L_HB_roof_owall_top_0_oc_f_i(l_frnt_total_f, dwelling_units, total_roof_area):
    """階層fにおける単位住戸iの屋根と主開口方位から時計回りに0°の方向に面した外壁の出隅部による熱橋の長さ（m）…………式(17a)
...
def get_L_HB_roof_owall_top_90_oc_f_i(total_roof_area, l_frnt_total_f, i):
    """階層fにおける単位住戸iの屋根と主開口方位から時計回りに90°の方向に面した外壁の出隅部による熱橋の長さ（m）…………式(17b)
...
def get_L_HB_roof_owall_top_180_oc_f_i(l_frnt_total_f, dwelling_units, f, building_floors):
    """階層fにおける単位住戸iの屋根と主開口方位から時計回りに180°の方向に面した外壁の出隅部による熱橋の長さ（m）…………式(17c)
...
def get_L_HB_roof_owall_top_270_oc_f_i(total_roof_area, l_frnt_total_f, i, dwelling_units):
    """階層fにおける単位住戸iの屋根と主開口方位から時計回りに270°の方向に面した外壁の出隅部による熱橋の長さ（m）…………式(17d)
...
def get_L_HB_roof_owall_top_0_ic_t_f_i(l_frnt_total_f, dwelling_units, total_roof_area, f, building_floors):
    """階層fにおける単位住戸iの屋根と主開口方位から時計回りに0°の方向に面した外壁の上部の入隅部による熱橋の長さ（m）…………式(18a)
...
def get_L_HB_roof_owall_top_0_ic_b_f_i(l_frnt_total_f, dwelling_units, dwelling_units_minus_1, total_roof_area_minus_1, f):
    """階層fにおける単位住戸iの屋根と主開口方位から時計回りに0°の方向に面した外壁の下部の入隅部による熱橋の長さ（m）…………式(18b-1,2)

    Args:
      l_frnt_total_f(float): 階層fにおける住棟の間口方向に面した住戸部分全体の外周の辺の長さ（m）…………式(29a)/get_l_frnt_total_f
      dwelling_units(float): 階層fにおける単位住戸iの総数（-）…………入力1.2(2)11
      dwelling_units_minus_1(float): 階層f-1における単位住戸iの総数（-）…………入力1.2(2)11
      total_roof_area_minus_1(float): 階層f-1における単位住戸の屋根面積の合計（m2）…………式(30)/get_total_roof_area
      f(int): 階層（-）
...
def get_L_HB_roof_iwall_top_90_f_i(total_roof_area, l_frnt_total_f, i, dwelling_units):
    """階層fにおける単位住戸iの屋根と主開口方位から時計回りに90°の方向に面した界壁による熱橋の長さ（m）…………式(19a-1,2)
...
def get_L_HB_roof_iwall_top_270_f_i(total_roof_area, l_frnt_total_f, i, dwelling_units):
    """階層fにおける単位住戸iの屋根と主開口方位から時計回りに270°の方向に面した界壁による熱橋の長さ（m）…………式(19b-1,2)
...
def get_L_dash_HB_roof_iwall_top_90_f_i(total_roof_area, l_frnt_total_f, dwelling_units):
    """階層fにおける単位住戸iの屋根と主開口方位から時計回りに90°の方向に面した室内壁による熱橋の加算長さ（m）…………式(19c)
...
def get_L_dash_HB_roof_iwall_top_0_f_i(total_roof_area, l_frnt_total_f, dwelling_units):
    """階層fにおける単位住戸iの屋根と主開口方位から時計回りに0°の方向に面した室内壁による熱橋の加算長さ（m）…………式(19d)
...
def get_L_HB_owall_owall_0_90_f_i(H_f, i):
    """階層fにおける単位住戸iの主開口部方位から時計回りに0°及び90°の方位に面した外壁同士の熱橋の長さ（m）…………式(20a)
...
def get_L_HB_owall_owall_90_180_f_i(H_f, i):
    """階層fにおける単位住戸iの主開口部方位から時計回りに90°及び180°の方位に面した外壁同士の熱橋の長さ（m）…………式(20b)
...
def get_L_HB_owall_owall_180_270_f_i(H_f, i, dwelling_units):
    """階層fにおける単位住戸iの主開口部方位から時計回りに180°及び270°の方位に面した外壁同士の熱橋の長さ（m）…………式(20c)
...
def get_L_HB_owall_owall_270_0_f_i(H_f, i, dwelling_units):
    """階層fにおける単位住戸iの主開口部方位から時計回りに270°及び0°の方位に面した外壁同士の熱橋の長さ（m）…………式(20d)
...
def get_L_HB_owall_iwall_0_90_f_i(H_f, i, dwelling_units):
    """階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した外壁と90°の方向に面した界壁による熱橋の長さ（m）…………式(21a-1,2)
...
def get_L_HB_owall_iwall_0_270_f_i(H_f, i, dwelling_units):
    """階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した外壁と270°の方向に面した界壁による熱橋の長さ（m）…………式(21b-1,2)
...
def get_L_HB_owall_iwall_180_90_f_i(H_f, i, dwelling_units):
    """階層fにおける単位住戸iの主開口方位から時計回りに180°の方向に面した外壁と90°の方向に面した界壁による熱橋の長さ（m）…………式(21c-1,2)
...
def get_L_HB_owall_iwall_180_270_f_i(H_f, i, dwelling_units):
    """階層fにおける単位住戸iの主開口方位から時計回りに180°の方向に面した外壁と270°の方向に面した界壁による熱橋の長さ（m）…………式(21d-1,2)
...
def get_L_dash_HB_owall_iwall_0_90_f_i(H_f, l_frnt_total_f, dwelling_units):
    """階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した外壁と90°の方向に面した室内壁による熱橋の加算長さ（m）…………式(21e)
...
def get_L_dash_HB_owall_iwall_90_0_f_i(H_f, l_dpth_total_f, i):
    """階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した外壁と0°の方向に面した室内壁による熱橋の加算長さ（m）…………式(21f)
...
def get_L_dash_HB_owall_iwall_180_90_f_i(H_f, l_frnt_total_f, dwelling_units):
    """階層fにおける単位住戸iの主開口方位から時計回りに180°の方向に面した外壁と90°の方向に面した室内壁による熱橋の加算長さ（m）…………式(21g)
...
def get_L_dash_HB_owall_iwall_270_0_f_i(H_f, l_dpth_total_f, dwelling_units, i):
    """階層fにおける単位住戸iの主開口方位から時計回りに270°の方向に面した外壁と0°の方向に面した室内壁による熱橋の加算長さ（m）…………式(21h)
...
def get_L_HB_owall_ifloor_0_bottom_t_f_i(l_frnt_total_f, dwelling_units, dwelling_units_plus_1, A_roof_f_i, total_ofloor_area_plus_1, f, building_floors):
    """階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した外壁の上部と界床による熱橋の長さ（m）…………式(22a-1,2,3)
...
def get_L_HB_owall_ifloor_0_bottom_b_f_i(l_frnt_total_f, dwelling_units, dwelling_units_minus_1, A_ofloor_f_i, total_roof_area_minus_1, f):
    """階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した外壁の下部と界床による熱橋の長さ（m）…………式(22b-1,2)
...
def get_L_HB_owall_ifloor_90_bottom_t_f_i(l_dpth_total_f, total_roof_area, l_frnt_total_f, f, building_floors, i):
    """階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した外壁の上部と界床による熱橋の長さ（m）…………式(22c-1,2)
...
def get_L_HB_owall_ifloor_90_bottom_b_f_i(l_dpth_total_f, total_ofloor_area, l_frnt_total_f, f, i):
    """階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した外壁の下部と界床による熱橋の長さ（m）…………式(22d-1,2)
...
def get_L_HB_owall_ifloor_180_bottom_t_f_i(l_frnt_total_f, dwelling_units, f, building_floors):
    """階層fにおける単位住戸iの主開口方位から時計回りに180°の方向に面した外壁の上部と界床による熱橋の長さ（m）…………式(22e)
...
def get_L_HB_owall_ifloor_180_bottom_b_f_i(l_frnt_total_f, dwelling_units, f):
    """階層fにおける単位住戸iの主開口方位から時計回りに180°の方向に面した外壁の下部と界床による熱橋の長さ（m）…………式(22f)
...
def get_L_HB_owall_ifloor_270_bottom_t_f_i(l_dpth_total_f, total_roof_area, l_frnt_total_f, f, building_floors, i, dwelling_units):
    """階層fにおける単位住戸iの主開口方位から時計回りに270°の方向に面した外壁の上部と界床による熱橋の長さ（m）…………式(22g-1,2)
...
def get_L_HB_owall_ifloor_270_bottom_b_f_i(l_dpth_total_f, total_ofloor_area, l_frnt_total_f, f, i, dwelling_units):
    """階層fにおける単位住戸iの主開口方位から時計回りに270°の方向に面した外壁の下部と界床による熱橋の長さ（m）…………式(22h-1,2)
...
def get_L_HB_owall_ufloor_0_bottom_f_i(l_frnt_total_f, dwelling_units, f):
    """階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した外壁と外気に通じる床裏に接する床による熱橋の長さ（m）…………式(23a)
...
def get_L_HB_owall_ufloor_90_bottom_f_i(l_dpth_total_f, f, i):
    """階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した外壁と外気に通じる床裏に接する床による熱橋の長さ（m）…………式(23b-1,2)
...
def get_L_HB_owall_ufloor_180_bottom_f_i(l_frnt_total_f, dwelling_units, f):
    """階層fにおける単位住戸iの主開口方位から時計回りに180°の方向に面した外壁と外気に通じる床裏に接する床による熱橋の長さ（m）…………式(23c)
...
def get_L_HB_owall_ufloor_270_bottom_f_i(l_dpth_total_f, f, i, dwelling_units):
    """階層fにおける単位住戸iの主開口方位から時計回りに270°の方向に面した外壁と外気に通じる床裏に接する床による熱橋の長さ（m）…………式(23d-1,2)
...
def get_L_HB_owall_ofloor_0_bottom_oc_f_i(l_frnt_total_f, dwelling_units, total_ofloor_area):
    """階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した外壁と外気に接する床の出隅部による熱橋の長さ（m）…………式(24a)
...
def get_L_HB_owall_ofloor_90_bottom_oc_f_i(total_ofloor_area, l_frnt_total_f, i):
    """階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した外壁と外気に接する床の出隅部による熱橋の長さ（m）…………式(24b)
...
def get_L_HB_owall_ofloor_180_bottom_oc_f_i():
    """階層fにおける単位住戸iの主開口方位から時計回りに180°の方向に面した外壁と外気に接する床の出隅部による熱橋の長さ（m）…………式(24c)
...
def get_L_HB_owall_ofloor_270_bottom_oc_f_i(total_ofloor_area, l_frnt_total_f, i, dwelling_units):
    """階層fにおける単位住戸iの主開口方位から時計回りに270°の方向に面した外壁と外気に接する床の出隅部による熱橋の長さ（m）…………式(24d)
...
def get_L_HB_owall_ofloor_0_bottom_ic_t_f_i(l_frnt_total_f, dwelling_units, dwelling_units_plus_1, total_ofloor_area_plus_1, f, building_floors):
    """階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した外壁の上部と外気に接する床の入隅部による熱橋の長さ（m）…………式(25a-1,2)
...
def get_L_HB_owall_ofloor_0_bottom_ic_b_f_i(l_frnt_total_f, dwelling_units, total_ofloor_area):
    """階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した外壁の下部と外気に接する床の入隅部による熱橋の長さ（m）…………式(25b)
...
def get_L_HB_iwall_ufloor_90_bottom_f_i(l_dpth_total_f, dwelling_units, f, i):
    """階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した界壁と外気に通じる床裏に接する床による熱橋の長さ（m）…………式(26a-1,2)
...
def get_L_HB_iwall_ufloor_270_bottom_f_i(l_dpth_total_f, dwelling_units, f, i):
    """階層fにおける単位住戸iの主開口方位から時計回りに270°の方向に面した界壁と外気に通じる床裏に接する床による熱橋の長さ（m）…………式(26b-1,2)
...
def get_L_dash_HB_iwall_ufloor_90_bottom_f_i(l_dpth_total_f, l_frnt_total_f, dwelling_units, f):
    """階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した室内壁と外気に通じる床裏に接する床による熱橋の加算長さ（m）…………式(26c)
...
def get_L_dash_HB_iwall_ufloor_0_bottom_f_i(l_frnt_total_f, l_dpth_total_f, dwelling_units, f):
    """階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した室内壁と外気に通じる床裏に接する床による熱橋の加算長さ（m）…………式(26d)
...
def get_L_HB_iwall_ofloor_90_bottom_f_i(total_ofloor_area, l_frnt_total_f, dwelling_units, i):
    """階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した界壁と外気に接する床による熱橋の長さ（m）…………式(27a-1,2)
...
def get_L_HB_iwall_ofloor_270_bottom_f_i(total_ofloor_area, l_frnt_total_f, dwelling_units, i):
    """階層fにおける単位住戸iの主開口方位から時計回りに270°の方向に面した界壁と外気に接する床による熱橋の長さ（m）…………式(27b-1,2)
...
def get_L_dash_HB_iwall_ofloor_90_bottom_f_i(total_ofloor_area, l_frnt_total_f, dwelling_units):
    """階層fにおける単位住戸iの主開口方位から時計回りに90°の方向に面した室内壁と外気に接する床による熱橋の加算長さ（m）…………式(27c)
...
def get_L_dash_HB_iwall_ofloor_0_bottom_f_i(l_frnt_total_f, dwelling_units, total_ofloor_area):
    """階層fにおける単位住戸iの主開口方位から時計回りに0°の方向に面した室内壁と外気に接する床による熱橋の加算長さ（m）…………式(27d)
...
def get_l_frnt_total_f(peripheral_length, total_floor_area):
    """階層fにおける住棟の間口方向に面した住戸部分全体の外周の辺の長さ（m）…………式(29a)
...
def get_l_dpth_total_f(peripheral_length, total_floor_area):
    """階層fにおける住棟の奥行き方向に面した住戸部分全体の外周の辺の長さ（m）…………式(29b)
...
def get_A_window_0_total_f(total_window_area, dwelling_units):
    """階層fにおける単位住戸の主開口方位から時計回りに0°の方向に面した部位の窓面積の合計（m2）…………式(31a)
...
def get_A_window_90_total_f(total_window_area, dwelling_units):
    """階層fにおける単位住戸の主開口方位から時計回りに90°の方向に面した部位の窓面積の合計（m2）…………式(31b)
...
def get_A_window_180_total_f(total_window_area, dwelling_units):
    """階層fにおける単位住戸の主開口方位から時計回りに180°の方向に面した部位の窓面積の合計（m2）…………式(31c)
...
def get_A_window_270_total_f(total_window_area, dwelling_units):
    """階層fにおける単位住戸の主開口方位から時計回りに270°の方向に面した部位の窓面積の合計（m2）…………式(31d)
...
def get_A_ufloor_total_f(total_floor_area, f):   
    """階層fにおける単位住戸の外気に通じる床裏に接する床面積の合計（m2）…………式(33)
...
def get_U_ceiling(U_ifloor):
    """上階側階床の熱貫流率（W/m2K）…………式(34)

    Args:
        U_ifloor (float): 下階側界床の熱貫流率（W/m2K）

    Returns:
        float: 上階側階床の熱貫流率（W/m2K）

    """

    return U_ifloor / (1 - 0.12 * U_ifloor)


def get_U_door():
    """玄関ドアの熱貫流率（W/m2K）…………式(35)

    Returns:
        float: 玄関ドアの熱貫流率（W/m2K）
